...
Use a constrained Google-inspired palette: Google blue #4285F4, red #EA4335, yellow #FBBC05, green #34A853, neutral ink #202124, white, warm gray, and dark gray.
...
export async function POST(request: Request) {
  ...
  if (!isEventGateOpen(request)) {
    return jsonResponse(
      {
        error: "La generación estará disponible el 6 de junio.",
      },
      { status: 403 },
    );
  }
